    ...
    public partial class initFromHome : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Swimteam", x => x.Id);
                });
            migrationBuilder.CreateTable(
                name: "AspNetRoles",
                columns: table => new
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SwimteamRole", x => x.Id);
                });
            migrationBuilder.CreateTable(
                name: "AspNetUsers",
                columns: table => new
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SwimteamUser", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Coach_Swimteam_TeamId",
                        column: x => x.TeamId,
            ...
            migrationBuilder.CreateTable(
                name: "CoachesPractices",
                columns: table => new
                {
                    Id = table.Column<Guid>(nullable: false),
                    CoachId = table.Column<Guid>(nullable: false),
                    CoachId1 = table.Column<string>(nullable: true),
                    ConcurrencyStamp = table.Column<string>(nullable: true),
                    PracticeId = table.Column<Guid>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CoachesPractices", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CoachesPractices_Coach_CoachId1",
                        column: x => x.CoachId1,
            ...
            migrationBuilder.CreateTable(
                name: "CoachesSwimmers",
                columns: table => new
                {
                    Id = table.Column<Guid>(nullable: false),
                    CoachId = table.Column<string>(nullable: true),
                    ConcurrencyStamp = table.Column<string>(nullable: true),
                    SwimmerId = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CoachesSwimmers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CoachesSwimmers_Coach_CoachId",
                        column: x => x.CoachId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CoachesSwimmers_Swimmer_SwimmerId",
            ...
            migrationBuilder.CreateTable(
                name: "SwimmersPractices",
                columns: table => new
                {
                    Id = table.Column<Guid>(nullable: false),
                    ConcurrencyStamp = table.Column<string>(nullable: true),
                    PracticeId = table.Column<Guid>(nullable: false),
                    SwimmerId = table.Column<Guid>(nullable: false),
                    SwimmerId1 = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SwimmersPractices", x => x.Id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SwimmersPractices_Swimmer_SwimmerId1",
                        column: x => x.SwimmerId1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            migrationBuilder.CreateTable(
                name: "SwimteamCoaches",
                columns: table => new
                {
                    Id = table.Column<Guid>(nullable: false),
                    CoachId = table.Column<Guid>(nullable: false),
                    CoachId1 = table.Column<string>(nullable: true),
                    ConcurrencyStamp = table.Column<string>(nullable: true),
                    SwimteamId = table.Column<Guid>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SwimteamCoaches", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SwimteamCoaches_Coach_CoachId1",
                        column: x => x.CoachId1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        column: x => x.SwimteamId,
                        principalTable: "Swimteam",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            migrationBuilder.CreateTable(
                name: "SwimteamSwimmers",
                columns: table => new
                {
                    Id = table.Column<Guid>(nullable: false),
                    ConcurrencyStamp = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SwimteamSwimmers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SwimteamSwimmers_Swimmer_SwimmerId1",
                        column: x => x.SwimmerId1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
        ...
        {
            migrationBuilder.DropTable("CoachesPractices");
            migrationBuilder.DropTable("CoachesSwimmers");
            migrationBuilder.DropTable("SwimmersPractices");
            migrationBuilder.DropTable("SwimteamCoaches");
            migrationBuilder.DropTable("SwimteamSwimmers");
            migrationBuilder.DropTable("UserProfile");
            migrationBuilder.DropTable("AspNetRoleClaims");
            migrationBuilder.DropTable("AspNetUserClaims");
            migrationBuilder.DropTable("AspNetUserLogins");
            migrationBuilder.DropTable("AspNetUserRoles");
            migrationBuilder.DropTable("Practice");
            migrationBuilder.DropTable("GImage");
            migrationBuilder.DropTable("AspNetRoles");
            migrationBuilder.DropTable("AspNetUsers");
            migrationBuilder.DropTable("Swimteam");
        }
    }
}
