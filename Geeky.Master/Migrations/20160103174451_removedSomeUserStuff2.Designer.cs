...
namespace Geeky.Master.Migrations
{
    ...
    [Migration("20160103174451_removedSomeUserStuff2")]
    partial class removedSomeUserStuff2
    {
            ...
            modelBuilder.Entity("Geeky.Models.Base.UserProfile", b =>
                {
                    ...
                    b.HasOne("Geeky.Models.Base.GeekyUser")
                        .WithOne()
                        .HasForeignKey("Geeky.Models.Base.UserProfile", "Id");
